...
export default function CountryItemMobile({ country }) {
    return (
        <Link href={`country/${country.code}`}>
            <div className="block p-4 w-full bg-white rounded-sm border border-gray-200 shadow-md">
                <table className="w-full border-slate-700 text-lg text-left text-black font-bold">
                    <tbody>
                        <tr>
